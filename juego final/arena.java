...
public class arena extends World
{
    ...
    private void prepare()
    {
        ...
        while(hola < 12){
            build car = new car();
            addObject(car, Greenfoot.getRandomNumber(100+200),Greenfoot.getRandomNumber(200+100));
            car.setLocation(Greenfoot.getRandomNumber(550), 170+Greenfoot.getRandomNumber(200));
            hola+=1;
        }
    }
    ...
    public void act(){
        ...
        while (Greenfoot.getRandomNumber(500) < 3) {
            oso oso = new oso();
